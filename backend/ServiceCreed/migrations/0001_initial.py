# Generated by Django 3.2.8 on 2021-11-05 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fullName', models.CharField(default='John Doe', max_length=200)),
                ('email', models.EmailField(max_length=254)),
                ('password', models.CharField(max_length=100)),
                ('address', models.CharField(max_length=500, null=True)),
                ('mobileNumber', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('profilePicture', models.ImageField(default='default.png', upload_to='appuser')),
